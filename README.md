...
4.  **Execute the assessment script:**
    ```powershell
    .\CIS-Assessment.ps1 -OutputDirectory "C:\CIS-Reports\CIS_Intune_W11_Audit"
    ```
    The script will ask you path for .audit file and run through the checks and display the assessment results in the console.

## 📁 Project Structure

```
CIS-Microsoft-Intune-for-Windows-11-v4.0.0-L1/
├── CIS-Assessment.ps1 # The main PowerShell assessment script
